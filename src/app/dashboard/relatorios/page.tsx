...
export default function RelatoriosPage() {
	...
	// Alertas de Reincidência legítimos baseados estritamente no Número de Patrimônio/Série
	// Alertas de Reincidência legítimos baseados estritamente no Número de Patrimônio/Série
	...
	); // <--- Adicionado o "as Record<string, number>"
	...
	return (
		<div className="p-6 max-w-7xl mx-auto space-y-6">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
					...
					<div>
						...
						<select
							...
							className="w-full border-gray-300 rounded-lg border px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
						>
			...
			{/* ÁREA DE EXIBIÇÃO DO RELATÓRIO (Só aparece após clicar em Gerar) */}
			{relatorioGerado ? (
